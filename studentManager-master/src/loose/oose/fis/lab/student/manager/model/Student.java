...
public class Student {
    ...
    public Student(String firstName, String lastName, int age, double meanGrade, Boolean scholarshipEligible) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(firstName, lastName, age, meanGrade, scholarshipEligible);
    }
